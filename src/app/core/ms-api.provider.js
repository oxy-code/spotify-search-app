(function ()
{
    ...
    function msApiProvider()
    {
        ...
        function register(key, resource)
        {
            ...
            /*if (angular.isDefined(resource[2]) && angular.isDefined(resource[2]['get']) && angular.isUndefined(resource[2]['get']['headers']['x-user'])) {
                resource[2]['get']['headers']['x-user'] = $cookies.get('token');              
            }*/
            ...
            /*var regex = /\/:(\w+)/g;
            var url = resourceObj.url, matches, params = {};
            ...
            if(angular.isDefined(resource[2])){
                // if already defined
                resourceObj.actions = resource[2];
            }
